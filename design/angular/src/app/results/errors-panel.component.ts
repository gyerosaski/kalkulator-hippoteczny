...
interface Group { section: string; items: FormError[]; }
      ...
      <div class="err-hero">
        <div class="err-hero-ico">
          <svg width="44" height="44" viewBox="0 0 44 44" aria-hidden="true">
            ...
            <circle cx="22" cy="22" r="20" fill="none" stroke="var(--err-deep)" stroke-opacity="0.25" stroke-width="1"/>
            <path d="M22 11 L33.5 30.5 H10.5 Z" fill="none" stroke="var(--err-deep)" stroke-width="1.8" stroke-linejoin="round"/>
            <path d="M22 17.5 V24" stroke="var(--err-deep)" stroke-width="1.8" stroke-linecap="round"/>
        ...
        <div class="err-hero-text">
          ...
          <h2 class="err-hero-title">
            Popraw <span class="err-hero-count">{{ totalLabel() }}</span>, aby zobaczyć harmonogram
          </h2>
          <p class="err-hero-sub">
            Wykresy, podsumowanie i tabela spłat pojawią się tutaj, gdy formularz po lewej będzie kompletny i spójny.
          </p>
        </div>
      </div>
                ...
                <li class="err-row">
                  <span class="err-row-bullet" aria-hidden="true">
                    <svg width="16" height="16" viewBox="0 0 16 16">
                      <path d="M8 1.5 L14.5 13 H1.5 Z" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round"/>
                      <path d="M8 5.6 V9.2" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>
                  ...
                  <div class="err-row-body">
                    ...
                    <div class="err-row-meta">
                      <span class="err-row-field">
                        @if (err.fieldNum) { <span class="err-row-num">{{ err.fieldNum }}</span> }
                        <span>{{ err.fieldLabel }}</span>
                      </span>
                      <button class="err-row-goto" (click)="goto.emit(err)">
                        Pokaż pole
                        <svg width="11" height="11" viewBox="0 0 11 11" aria-hidden="true">
                          <path d="M2 5.5 H9 M6 2.5 L9 5.5 L6 8.5"
        ...
        <div class="err-ghost-charts">
          <div class="err-ghost-card">
            <svg viewBox="0 0 120 120" class="err-ghost-donut">
              <circle cx="60" cy="60" r="46" fill="none" stroke="var(--err-ghost-line)"
                stroke-width="14" stroke-dasharray="4 6"/>
            </svg>
          ...
          <div class="err-ghost-card err-ghost-card--chart">
            <svg viewBox="0 0 240 80" preserveAspectRatio="none" class="err-ghost-trend">
              <path d="M0 70 C 40 60, 70 50, 110 38 S 200 18, 240 10"
                fill="none" stroke="var(--err-ghost-line)" stroke-width="1.5" stroke-dasharray="3 4"/>
...
export class ErrorsPanelComponent {
  ...
  pluralFor(n: number): string { return pluralErr(n); }
}
