  ...
  template: `
    ...
    >
      ...
      <div class="row row--3">
        ...
        <app-field label="Wyliczenie składki" num="4b">
          <app-select
            ...
            value="% wartości nieruchomości"
            (valueChange)="(0)"
          />
        </app-field>
        <app-field label="Wartość">
          <app-number-input
            [value]="calc.insurancePct() * 10000"
            (valueChange)="calc.insurancePct.set($event / 10000)"
            suffix="‰"
            [decimals]="2"
          />
        </app-field>
      ...
      <div class="muted small">
        Pozostałe pozycje (ubezp. niskiego wkładu, na życie, od utraty pracy, dodatkowe koszty,
        promocyjne oprocentowanie) — schowane dla czytelności.
      </div>
    </app-section>
  `,
})
