...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 1"
        [class.is-closed]="openCostSub() !== 1"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(1)"
          [attr.aria-expanded]="openCostSub() === 1"
        >
          <span class="cost-sub-num">1</span
          ><span class="cost-sub-title">Prowizja za udzielenie</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
              stroke-width="1.5"
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 2"
        [class.is-closed]="openCostSub() !== 2"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(2)"
          [attr.aria-expanded]="openCostSub() === 2"
        >
          <span class="cost-sub-num">2</span><span class="cost-sub-title">Opłata za wycenę</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 3"
        [class.is-closed]="openCostSub() !== 3"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(3)"
          [attr.aria-expanded]="openCostSub() === 3"
        >
          <span class="cost-sub-num">3</span
          ><span class="cost-sub-title">Ubezpieczenie pomostowe</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 4"
        [class.is-closed]="openCostSub() !== 4"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(4)"
          [attr.aria-expanded]="openCostSub() === 4"
        >
          <span class="cost-sub-num">4</span
          ><span class="cost-sub-title">Ubezpieczenie nieruchomości</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 5"
        [class.is-closed]="openCostSub() !== 5"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(5)"
          [attr.aria-expanded]="openCostSub() === 5"
        >
          <span class="cost-sub-num">5</span
          ><span class="cost-sub-title">Ubezpieczenie niskiego wkładu</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 6"
        [class.is-closed]="openCostSub() !== 6"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(6)"
          [attr.aria-expanded]="openCostSub() === 6"
        >
          <span class="cost-sub-num">6</span
          ><span class="cost-sub-title">Ubezpieczenie na życie</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 7"
        [class.is-closed]="openCostSub() !== 7"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(7)"
          [attr.aria-expanded]="openCostSub() === 7"
        >
          <span class="cost-sub-num">7</span
          ><span class="cost-sub-title">Ubezpieczenie od utraty pracy</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 8"
        [class.is-closed]="openCostSub() !== 8"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(8)"
          [attr.aria-expanded]="openCostSub() === 8"
        >
          <span class="cost-sub-num">8</span><span class="cost-sub-title">Dodatkowe koszty</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
      ...
      <div
        class="cost-sub cost-sub--acc"
        [class.is-open]="openCostSub() === 9"
        [class.is-closed]="openCostSub() !== 9"
      >
        <button
          type="button"
          class="cost-sub-head"
          (click)="toggleCostSub(9)"
          [attr.aria-expanded]="openCostSub() === 9"
        >
          <span class="cost-sub-num">9</span
          ><span class="cost-sub-title">Promocyjna wysokość oprocentowania</span
          ><svg class="cost-sub-chev" width="10" height="10" viewBox="0 0 10 10">
            <path
              d="M3 1 L7 5 L3 9"
              stroke="currentColor"
...
export class CostsComponent {
  ...
  toggleCostSub(n: number) {
    this.openCostSub.update((c) => (c === n ? null : n));
  }
