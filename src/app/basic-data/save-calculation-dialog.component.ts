  ...
  template: `
    ...
    <div mat-dialog-content>
      <mat-form-field appearance="fill" style="width: 100%;">
        ...
        <input matInput [formControl]="nameCtrl" placeholder="np. Moja kalkulacja" (keydown.enter)="onSave()" />
        <mat-error *ngIf="nameCtrl.hasError('required')">Nazwa jest wymagana.</mat-error>
      </mat-form-field>
    </div>
    <div mat-dialog-actions align="end">
      <button mat-button mat-dialog-close>Anuluj</button>
      <button mat-raised-button color="primary" (click)="onSave()" [disabled]="nameCtrl.invalid">Zapisz</button>
    </div>
  `
})
